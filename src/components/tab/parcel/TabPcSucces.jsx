...
import PcDetailRepair from "../../modal/parcel/PcDetailRepair";

function TabPcSucces() {
  dayjs.extend(utc);
  ...
  useEffect(() => {
    ...
    axios
      .post(
        `http://localhost:5000/api/repair-list-parcel-success`,
        {},
        {
          headers: {
  ...
  const columns = [
    ...
    {
      name: <div className='font-bold'>การดำเนินการ</div>,
