...
function DetailRepair({ repairId }) {
  const id = repairId;
          ...
          <div className='overflow-x-auto'>
            <table className='table'>
              ...
              <tbody>
                ...
                <tr className='border-b-2 border-gray-200 '>
                  <th className='bg-base-200 w-20'>จำนวน</th>
                  <td>{repairData.quantity}</td>
                </tr>
                <tr className='border-b-2 border-gray-200 '>
                  <th className='bg-base-200 w-20'>หน่วย</th>
                  <td>{repairData.unit}</td>
                </tr>
                <tr className='border-b-2 border-gray-200 '>
                  <th className='bg-base-200 w-20'>อาการที่ชำรุด</th>
                  <td>{repairData.malfunction}</td>
                </tr>
                <tr className='border-b-2 border-gray-200 '>
                  <th className='bg-base-200 w-20'>ตำแหน่งที่ชำรุด</th>
