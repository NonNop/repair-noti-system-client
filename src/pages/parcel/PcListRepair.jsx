...
import MhRepair from "../../components/modal/mechanice/MhRepair";

function PcListRepair() {
  dayjs.extend(utc);
  ...
  useEffect(() => {
    ...
    axios
      .post(
        `http://localhost:5000/api/repair-list`,
        {},
        {
          headers: {
  ...
  return (
    <main>
      <div className='mx-5 mt-10'>
        <h1 className='text-3xl font-bold'>ใบแจ้งซ่อมวัสดุ</h1>
      </div>
